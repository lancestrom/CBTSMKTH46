...
class TokenKeluar : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_token_keluar)

        val etToken = findViewById<EditText>(R.id.et_token)
        val btnSubmit = findViewById<Button>(R.id.btn_submit)
        val btnBack = findViewById<Button>(R.id.btn_back_to_exam)
        ...
        onBackPressedDispatcher.addCallback(this, object : OnBackPressedCallback(true) {
            override fun handleOnBackPressed() {
                Toast.makeText(this@TokenKeluar, "Aplikasi Terkunci!", Toast.LENGTH_SHORT).show()
                hideSystemUI()
                bringToFront()
            }
        })
    ...
    private fun checkToken(token: String) {
        val url = "http://project.cbt.smkth-jakbar.com/token/api/check_token"
